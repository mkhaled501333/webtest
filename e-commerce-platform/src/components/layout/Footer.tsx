        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div className="col-span-1 sm:col-span-2 lg:col-span-2">
            <div className="flex items-center mb-3 sm:mb-4">
              <span className="text-xl sm:text-2xl font-bold text-primary-400">StyleHub</span>
            </div>
            <p className="text-gray-300 mb-3 sm:mb-4 max-w-md text-sm sm:text-base">
              Discover unique fashion from local brands. Try before you buy with our AR technology.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-sm font-semibold text-gray-200 tracking-wider uppercase mb-3 sm:mb-4">
              Quick Links
            </h3>
            <ul className="space-y-1 sm:space-y-2">
              <li>
                <Link to="/brands" className="text-gray-300 hover:text-white text-sm transition-colors">
                  Browse Brands
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/ar-try-on" className="text-gray-300 hover:text-white text-sm transition-colors">
                  AR Try-On
                </Link>
              </li>
              <li>
                <Link to="/new-arrivals" className="text-gray-300 hover:text-white text-sm transition-colors">
                  New Arrivals
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-6 sm:mt-8 pt-6 sm:pt-8">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-3 sm:space-y-0">
            <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-6 text-center sm:text-left">
              ...
              <Link to="/brand-partnership" className="text-gray-300 hover:text-white text-sm transition-colors">
                Brand Partnership
              </Link>
            </div>
